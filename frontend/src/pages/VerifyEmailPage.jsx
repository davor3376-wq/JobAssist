      ...
      <div className="text-center py-8">
        {status === "loading" && (
          <>
            ...
            <h2 className="text-xl font-bold text-gray-900">E-Mail wird bestaetigt...</h2>
          </>
        )}
        {status === "success" && (
          <>
            ...
            <h2 className="text-xl font-bold text-gray-900 mb-2">E-Mail bestaetigt</h2>
            <p className="text-sm text-gray-500 mb-4">Deine E-Mail-Adresse wurde erfolgreich bestaetigt.</p>
        ...
        {status === "error" && (
          <>
            ...
            <h2 className="text-xl font-bold text-gray-900 mb-2">Bestaetigung fehlgeschlagen</h2>
            <p className="text-sm text-gray-500 mb-4">Der Link ist ungueltig oder abgelaufen.</p>
