    ...
    >
      ...
      >
        <div className="mb-4 flex items-start justify-between">
          ...
          <button onClick={() => setData(null)} className="rounded-lg p-1.5 text-slate-400 hover:bg-slate-800">
            <X className="h-5 w-5" />
          </button>
        </div>
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={() => setData(null)}
            className="rounded-xl px-4 py-2.5 font-medium text-slate-300 transition-colors hover:bg-slate-800"
          >
            Später
          </button>
        </div>
